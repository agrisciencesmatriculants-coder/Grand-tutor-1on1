  ...
  if (!gcalId) {
    return (
      <section aria-label="Google Calendar" className="card-playbill border-dashed p-6 text-center">
        ...
        <h3 className="font-display mt-2 text-lg font-bold text-gold-light">
          The shared calendar awaits its cue
        </h3>
        <p className="mx-auto mt-2 max-w-md text-sm text-cream-dim">
          George can add <code className="font-mono text-gold-light">VITE_GCAL_ID</code> (a Google
          Calendar ID) to the environment variables to show the shared Google Calendar right here
    ...
    <section aria-label="Google Calendar" className="card-playbill relative overflow-hidden p-4 sm:p-5">
      ...
      <div className="relative">
        <div className="mb-3 flex items-baseline justify-between gap-3">
          ...
          <p className="font-label text-[9px] text-cream-dim/70">Africa/Johannesburg</p>
        </div>
        <div className="overflow-hidden rounded-lg border border-gold/25 bg-stage-deep">
          <iframe
