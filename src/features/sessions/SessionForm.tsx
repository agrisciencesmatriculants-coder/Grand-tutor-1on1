        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <label className="block sm:col-span-2">
            <span className="font-label mb-1 block text-[10px] text-ink-soft">
              Title <span className="text-terra-deep">*</span>
            </span>
            <input
              type="text"
          ...
          <label className="block">
            <span className="font-label mb-1 block text-[10px] text-ink-soft">Subject</span>
            <input
              type="text"
              className="input-stage"
              value={subject}
          ...
          <label className="block">
            <span className="font-label mb-1 block text-[10px] text-ink-soft">Location</span>
            <input
              type="text"
              className="input-stage"
              value={location}
          ...
          <label className="block">
            <span className="font-label mb-1 block text-[10px] text-ink-soft">Date</span>
            <input
              type="date"
              className="input-stage [color-scheme:light]"
              value={date}
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="block">
              <span className="font-label mb-1 block text-[10px] text-ink-soft">Starts</span>
              <input
                type="time"
                className="input-stage [color-scheme:light]"
                value={startTime}
            ...
            <label className="block">
              <span className="font-label mb-1 block text-[10px] text-ink-soft">Ends</span>
              <input
                type="time"
                className="input-stage [color-scheme:light]"
                value={endTime}
          ...
          <label className="block sm:col-span-2">
            <span className="font-label mb-1 block text-[10px] text-ink-soft">Description</span>
            <textarea
              className="input-stage min-h-[5rem] resize-y"
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              placeholder="Topics to cover, pages to prepare, and materials to bring…"
              maxLength={600}
            />
          </label>
        </div>
