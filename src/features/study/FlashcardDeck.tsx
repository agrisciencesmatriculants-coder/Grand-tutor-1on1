...
export default function FlashcardDeck({ cards }: FlashcardDeckProps) {
  ...
  if (!card) {
    return <p className="text-sm text-ink-soft">No flashcards in this deck yet.</p>;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="font-label relative text-[9px] text-gold-deep">Front of card</p>
            <p className="font-display relative mt-3 text-xl font-bold leading-snug text-ink sm:text-2xl">
              {card.front}
            </p>
            <p className="font-label relative mt-4 text-[9px] text-ink-soft/60">
          ...
          >
            <div className="spotlight" />
            <p className="font-label relative text-[9px] text-gold-deep">Back of card</p>
            <p className="relative mt-3 text-base leading-relaxed text-ink sm:text-lg">
              {card.back}
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        <span className="font-label min-w-[4.5rem] text-center text-xs text-gold-deep">
          {index + 1} / {total}
        </span>
      ...
      <p className="text-center font-label text-[9px] text-ink-soft/60">
